...
// Chinese 5-point scale to 4.0 scale page
export const metadata: Metadata = {
  title: 'Chinese 5-point Scale to 4.0 GPA Converter',
  description: 'Convert your Chinese 5-point scale GPA to 4.0 scale for study abroad applications. Free, accurate, and easy to use.',
  keywords: 'Chinese 5-point scale to 4.0, 中国5分制转GPA, Chinese GPA converter, study abroad from China',
  openGraph: {
    title: 'Chinese 5-point Scale to 4.0 GPA Converter',
    description: 'Convert your Chinese 5-point scale GPA to 4.0 scale for study abroad applications.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.gpa-converter.online/scales/cn_5scale'
  }
}

export default function Chinese5ScaleGPAPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary to-white py-12">
      <div className="container mx-auto px-4 max-w-3xl">
        {/* Header */}
        <header className="text-center mb-12">
          <h1 className="text-3xl font-bold text-text mb-2">Chinese 5-point Scale to 4.0 GPA Converter</h1>
          <p className="text-lg text-gray-600">Convert your Chinese 5-point scale GPA to 4.0 scale</p>
        </header>
        ...
        <main className="bg-white rounded-xl shadow-lg p-8">
          <div className="space-y-6">
            {/* Introduction */}
            <section>
              <h2 className="text-2xl font-semibold text-text mb-4">Chinese 5-point Scale to 4.0 Scale Conversion</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Some Chinese universities use a 5-point GPA scale, while many international universities (especially in the US) use a 4.0 scale. Our converter helps you easily convert your Chinese 5-point scale GPA to the 4.0 scale for study abroad applications.
              </p>
            </section>
                ...
                <table className="min-w-full border border-gray-300 rounded-lg">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="py-3 px-4 border-b text-left">Chinese 5-point Scale</th>
                      <th className="py-3 px-4 border-b text-left">4.0 Scale</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="py-3 px-4 border-b">4.8-5.0</td>
                      <td className="py-3 px-4 border-b">4.0</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 border-b">4.5-4.7</td>
                    ...
                    <tr>
                      <td className="py-3 px-4">0.0-1.9</td>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                ...
                <li>Select "5分制" from the scale options</li>
                <li>Enter your Chinese 5-point scale GPA</li>
