...
// UK 7-point scale to 4.0 scale page
export const metadata: Metadata = {
  title: 'UK GPA to 4.0 Scale Converter - Convert British 7-point GPA',
  description: 'Convert your UK 7-point scale GPA to 4.0 scale for study abroad applications. Free, accurate, and easy to use.',
  keywords: 'UK GPA to 4.0, British GPA converter, 7-point scale to 4.0, UK university GPA conversion',
  openGraph: {
    title: 'UK GPA to 4.0 Scale Converter',
    description: 'Convert your UK 7-point scale GPA to 4.0 scale for study abroad applications.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.gpa-converter.online/scales/uk'
  }
}

export default function UKGPAPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary to-white py-12">
      <div className="container mx-auto px-4 max-w-3xl">
        {/* Header */}
        <header className="text-center mb-12">
          <h1 className="text-3xl font-bold text-text mb-2">UK GPA to 4.0 Scale Converter</h1>
          <p className="text-lg text-gray-600">Convert your British 7-point scale GPA to 4.0 scale</p>
        </header>
        ...
        <main className="bg-white rounded-xl shadow-lg p-8">
          <div className="space-y-6">
            {/* Introduction */}
            <section>
              <h2 className="text-2xl font-semibold text-text mb-4">UK 7-point Scale to 4.0 Scale Conversion</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                The UK higher education system uses a 7-point GPA scale, while many international universities (especially in the US) use a 4.0 scale. Our converter helps you easily convert your UK GPA to the 4.0 scale for study abroad applications.
              </p>
            </section>
                ...
                <table className="min-w-full border border-gray-300 rounded-lg">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="py-3 px-4 border-b text-left">UK 7-point Scale</th>
                      <th className="py-3 px-4 border-b text-left">4.0 Scale</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="py-3 px-4 border-b">7.0</td>
                      <td className="py-3 px-4 border-b">4.0</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 border-b">6.5-6.9</td>
                      <td className="py-3 px-4 border-b">3.7</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 border-b">6.0-6.4</td>
                      <td className="py-3 px-4 border-b">3.3</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 border-b">5.5-5.9</td>
                      <td className="py-3 px-4 border-b">3.0</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 border-b">5.0-5.4</td>
                      <td className="py-3 px-4 border-b">2.7</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-4 border-b">4.5-4.9</td>
                    ...
                    <tr>
                      <td className="py-3 px-4">0.0-3.9</td>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                ...
                <li>Select "英国7分制" from the scale options</li>
                <li>Enter your UK GPA score</li>
            ...
            {/* Tips */}
            <section>
              <h2 className="text-xl font-semibold text-text mb-4">Tips for UK Students</h2>
              <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-2">
                <li>Check with your target universities for their specific conversion policies</li>
                <li>Some universities may have their own UK GPA to 4.0 scale conversion methods</li>
                <li>Keep your original UK transcripts for reference</li>
