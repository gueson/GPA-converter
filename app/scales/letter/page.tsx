...
// Letter grade scale to 4.0 scale page
export const metadata: Metadata = {
  title: 'Letter Grade to 4.0 Scale Converter - Convert Letter Grades',
  description: 'Convert your letter grades (A+, A, B+, etc.) to 4.0 scale for study abroad applications. Free, accurate, and easy to use.',
  keywords: 'Letter grade to GPA, A+ to 4.0, letter grade converter, study abroad GPA conversion',
  openGraph: {
    title: 'Letter Grade to 4.0 Scale Converter',
    description: 'Convert your letter grades (A+, A, B+, etc.) to 4.0 scale for study abroad applications.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.gpa-converter.online/scales/letter'
  }
}

export default function LetterGPAPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary to-white py-12">
      <div className="container mx-auto px-4 max-w-3xl">
        {/* Header */}
        <header className="text-center mb-12">
          <h1 className="text-3xl font-bold text-text mb-2">Letter Grade to 4.0 Scale Converter</h1>
          <p className="text-lg text-gray-600">Convert your letter grades to 4.0 scale</p>
        </header>
        ...
        <main className="bg-white rounded-xl shadow-lg p-8">
          <div className="space-y-6">
            {/* Introduction */}
            <section>
              <h2 className="text-2xl font-semibold text-text mb-4">Letter Grade to 4.0 Scale Conversion</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                Many educational systems use letter grades (A+, A, A-, B+, etc.) to evaluate student performance. Our converter helps you easily convert these letter grades to the 4.0 scale commonly used by universities in the United States and other countries for study abroad applications.
              </p>
            </section>
                ...
                <table className="min-w-full border border-gray-300 rounded-lg">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="py-3 px-4 border-b text-left">Letter Grade</th>
                      <th className="py-3 px-4 border-b text-left">4.0 Scale</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="py-3 px-4 border-b">A+, A</td>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-2">
                ...
                <li>Select "字母制" from the scale options</li>
                <li>Enter your letter grade (A+, A, B+, etc.)</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-2">
                ...
                <li>Keep your original transcripts for reference</li>
